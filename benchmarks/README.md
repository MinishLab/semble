...
**How the benchmark was built**: queries and ground-truth relevance labels are generated by Claude Sonnet 4.6. The same model is used as LLM-as-judge to score retrieval results. This means the benchmark reflects what the model considers relevant code for a given query, not human judgement.
