...
from semble.installer.agents import AGENTS, INTEGRATION_IDS
...
def _cli_main() -> None:
    ...
    if args.command == "savings":
        ...
        integration_ids = None if not args.type or "all" in args.type else args.type
